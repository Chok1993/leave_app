...
# ----------------------------
# 📅 การมาปฏิบัติงาน (Final Fixed Version – รองรับ scan_report.xlsx)
# ----------------------------
    ...
    for name in df_month[name_col].unique():
        for d in date_range:
            ...
            # 🔹 ตรวจว่ามีการสแกนวันนั้นไหม (แก้บั๊ก date mismatch)
            att = df_month[
