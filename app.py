...
# ===== ฟอร์มบันทึกการไปราชการ =====
    ...
    if submitted:
        if not data["ชื่อ-สกุล"]:
            ...
            # ✅ 1. เพิ่มรายการหลัก
            main_entry = pd.DataFrame([data])

            # ✅ 2. เพิ่มข้อมูลผู้ร่วมเดินทางโดยอัตโนมัติ
            companion_entries = []
            for p in companions:
                companion_data = {
                    ...
                    "ผู้ร่วมเดินทาง": data["ชื่อ-สกุล"],
                    "สถานที่": data["สถานที่"],
                    "ผู้จัด": data["ผู้จัด"],
            ...
            st.success("✅ บันทึกข้อมูลเรียบร้อย (รวมผู้ร่วมเดินทางแล้ว)")
