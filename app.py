...
if menu == "การไปราชการ":
    ...
    st.write(f"📅 จำนวนคนทั้งหมดที่ไป: {len(df_scan)} คน")
    st.write(f"📋 จำนวนวันทั้งหมด: {df_scan['จำนวนวันที่ไป'].sum()} วัน")
...
# ===== ฟอร์มบันทึกการลา =====
    ...
    st.write(f"📅 จำนวนคนที่ลาทั้งหมด: {len(df_report)} คน")
    st.write(f"📋 จำนวนวันลาทั้งหมด: {df_report['วันที่สิ้นสุด'].sub(df_report['วันที่เริ่ม']).dt.days.sum()} วัน")
