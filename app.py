...
# ✅ Final Version: แก้ไขชื่อไฟล์ข้อมูลสแกน
# ====================================================
...
FILE_ATTEND = "scan_report.xlsx" # ✅ แก้ไขชื่อไฟล์ให้ถูกต้อง
...
if menu == "หน้าหลัก":
    ...
    if df_att.empty:
        st.warning("ยังไม่มีข้อมูลสแกนเข้า-ออกในระบบ (จากไฟล์ scan_report.xlsx)")
        st.stop()
