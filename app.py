    ...
    for name in df_month[name_col].unique():
        for d in date_range:
            ...
            if not att.empty:
                ...
                # ✅ ตรวจวันหยุดเสาร์-อาทิตย์
                if d.weekday() >= 5:
                    rec["สถานะ"] = "วันหยุด"
                else:
                    # ✅ ตรวจตรรกะเวลาเข้าออก
                    try:
                ...
                # ❌ ไม่มีข้อมูลสแกน — ตรวจลาและราชการ
                in_leave = (
