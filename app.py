    ...
    if df_att.empty:
        ...
        if "วันที่" not in df_att.columns:
            ...
            if df_att.empty:
                ...
                monthly_summary = df_att.groupby("เดือน")["ชื่อ-สกุล"].count().reset_index(name="จำนวนรายการสแกน")
                ...
                if "กลุ่มงาน" in df_att.columns:
                    ...
                    group_summary = df_att.groupby("กลุ่มงาน")["ชื่อ-สกุล"].count().reset_index(name="จำนวนรายการสแกน")
