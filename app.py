...
# ----------------------------
# 📅 การมาปฏิบัติงาน (เวอร์ชันปรับปรุง ตรวจเวลาจริง + ไขว้ 3 ฐานข้อมูล)
# ----------------------------
    ...
    # -----------------------------
    # 🔍 ตรวจสอบแต่ละวัน (ใช้เวลาเข้า–ออกจริง)
    # -----------------------------
    records = []
        ...
        for d in date_range:
            ...
            if not att.empty:
                ...
                if d.weekday() >= 5:
                    ...
                    # แปลงเวลาเข้า–ออกเป็น datetime.time
                    try:
    ...
    preferred_order = ["มาปกติ", "มาสาย", "ออกก่อน", "มาสายและออกก่อน", "ลา", "ไปราชการ", "ขาดงาน", "วันหยุด", "รวมทั้งหมด"]
