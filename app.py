...
# ✅ Final Version: แก้ไข NameError: 'service' is not defined
# ====================================================
...
# --- ‼️ แก้ไขโดยย้ายบรรทัดนี้ขึ้นมาไว้ที่นี่ ‼️ ---
...
if menu == "หน้าหลัก":
    ...
    for name in names_to_process:
        for d in date_range:
            ...
            if in_leave:
                ...
                row = att.iloc[0]
                rec.update({k: row.get(k, "") for k in ["เวลาเข้า", "เวลาออก", "หมายเหตุ"]})
    ...
    def color_status(val):
        ...
        for key, color in colors.items():
            if key in str(val): return color
        return ""
