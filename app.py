...
# ----------------------------
# 📅 การมาปฏิบัติงาน (เวอร์ชันสมบูรณ์ ตรวจไขว้ 3 ฐานข้อมูล + เวลาเข้า-ออกจริง)
# ----------------------------
    ...
    # ✅ เพิ่มคอลัมน์ "เดือน" เพื่อเลือกช่วงเวลา
    ...
    for name in df_month[name_col].unique():
        for d in date_range:
            ...
            # ✅ ไม่มีข้อมูลสแกน → ตรวจสอบลา / ราชการ
            else:
                in_leave = (
